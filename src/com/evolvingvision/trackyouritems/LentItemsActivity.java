...
public class LentItemsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Transaction> lentItems = TrackYourItemsDao.getTransactionItems(this,Constants.LENT_STATUS_ID);
		TransactionAdapter adapter = new TransactionAdapter(this, lentItems);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.lent_items, menu);
		return true;
	}
